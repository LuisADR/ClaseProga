...
public class MatrizGUI extends JFrame implements ActionListener
{
    ...
    {
        // Poner los panels no visibles y borrar su contenido y hacerlos visibles nuevamente
        ...
        // 2. Crear Matrices de los JTextFields y de numeros enteros
        tfMatrizA = new JTextField[r][c];
        tfMatrizB = new JTextField[r][c];
        tfMatrizC = new JTextField[r][c];
        
        // Crear Matrices de int
        matrizA = new int[r][c];
        matrizB = new int[r][c];
        matrizC = new int[r][c];
        
        // 3. Relacionar tfMatrices con panels: Crear los JTextFields de las casillas correspondientes de las Matrices A, B y C.
        //    Adicionar cada casilla de la Matriz en el Panel correspondiente
        // tfMatrizA y panelA
        for(int i=0; i<r; i++)
        {
            for(int j=0; j<c; j++)
    ...
    {
        //JOptionPane.showMessageDialog(null,"Desplegar Panels para Multiplicar Matrices...");
        // Poner los panels no visibles y borrar su contenido y hacerlos visibles nuevamente
        panelA.setVisible(false);
        panelB.setVisible(false);
        panelC.setVisible(false);
        ...
        // 2. Crear Matrices de los JTextFields
        tfMatrizA = new JTextField[r][c];
        ...
        // 5. Adicionar boton de Multiplicar al panel
