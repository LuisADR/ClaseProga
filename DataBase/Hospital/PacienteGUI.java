...
public class PacienteGUI extends JPanel implements ActionListener{
  ...
  public PacienteGUI(){
    ...
    bConsultar = new JButton("Consultar Pacientes");
  ...
  public void actionPerformed(ActionEvent e){
    ...
    if(e.getSource() == bCapturar){
      ...
      if(respuesta.equals("VACIO")){
        ...
        if(respuesta.equals("NO_NUMERICO")){
          ...
          taDatos.setText(hospital.capturarPaciente(respuesta));
        }
      }
    }
    ...
    if(e.getSource() == bConsultarClave){
      ...
      String respuesta = hospital.consultarClave(tfClave.getText());
    ...
    if(e.getSource() == bActualizar){
      ...
      if(respuesta.equals("VACIO")){
        ...
        if(respuesta.equals("NO_NUMERICO")){
          ...
          taDatos.setText(hospital.actualizarPaciente(respuesta));
          inactivarBotones();
        }
      }
    }
